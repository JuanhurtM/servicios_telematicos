                ...
                <div class="col">
                    <form class="mt-4 mb-5" role="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            <div class="text-center mt-4" >
                                <input type="submit" name="get" value="Get" class="btn btn-success fw-bold rounded-pill"/>
                                <input type="submit" value="Post" name="post" class="btn btn-dark fw-bold rounded-pill"/>
                                <input type="submit" value="Put" name="put" class="btn btn-warning fw-bold rounded-pill"/>
                                <input type="submit" value="Delete" name="delete" class="btn btn-danger fw-bold rounded-pill"/>
                            </div>
                    </form>
                    <label for="report" class="form-label mb-2 fw-bold">Report</label>
